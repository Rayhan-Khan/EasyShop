          ...
          <div className="w-[90%] sm:w-[80%] p-2">
            <div className="flex flex-wrap sm:flex-nowrap gap-4">
              ...
              <div className=" w-[100%] sm:w-[49%]">
                ...
                <p>
                  Save per product :{" "}
                  {product[0].Price - product[0].calculatePrice}TK
                </p>
              {role!=='admin' && <div> 
                <button
                  onClick={() => addCart(product[0]?._id)}
                  className="mt-3 sm:mt-[200px] text-white hover:opacity-90 w-[150px] mb-3 sm:mx-5 bg-[#22c55e] p-2 rounded-lg"
                >
                  Add To Cart
                </button>
                <button
                  onClick={() => addCart(product[0]?._id, 1)}
                  className="mt-3 sm:mt-[200px] text-white hover:opacity-90 w-[150px] mb-3 sm:mx-5 bg-[#22c55e] p-2 rounded-lg"
                >
                  Buy Now
                </button>
                ...
                <button
                  className="mt-3 sm:mt-[200px] text-white hover:opacity-90 w-[150px] mb-3 sm:mx-5 bg-red-700 p-2 rounded-lg"
                >
                  DELETE
                </button>
                </div>}
            ...
            <div>
              ...
              <ul className="list-disc">
                {arr.map(
                  (it, index) => it.length > 0 && <li key={index}>{it}</li>
                )}
              </ul>
            </div>
          </div>
